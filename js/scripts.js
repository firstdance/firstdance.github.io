(function() {
  ...
  function buildFooter() {
    ...
    footer += '<a class="footer__links--link" href="/about">About</a>';
    footer += '<a class="footer__links--link" href="/classes">Classes</a>';
    footer += '<a class="footer__links--link" href="/contact">Contact</a>';
    footer += '</div>';
    ...
    footer += '<div class="footer__intouch--main">';
    footer += '<a class="header__social--link" href="https://www.facebook.com/firstdancelongcrendon" target="_blank">First Dance Facebook</a>';
    footer += '</div>';
    footer += '</div>';
    footer += '</div>';
    footer += '</div>';
